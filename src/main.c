...
static bool show_zero_for_hours = false;
...
static void spock_layer_update_proc(Layer *layer, GContext *ctx) {
  ...
  if(current_middle_animation > 0) {
    ...
    //stop_animation = !draw_array(ctx, -1, -1, -1, -1, SHAPES2X2[middle_shape], 2, 2, color_spocks_h10) && stop_animation;
    ...
    stop_animation = !draw_array(ctx, 1, 0, NUMBER_WIDTH, NUMBER_HEIGHT,
                                 SHAPES2X2[middle_shape], true, 2, 2, color_spocks_h10) && stop_animation;
    stop_animation = !draw_array(ctx, NUMBER_WIDTH + 1, 0, NUMBER_WIDTH, NUMBER_HEIGHT,
                                 SHAPES2X2[middle_shape], true, 2, 2, color_spocks_h1) && stop_animation;
    stop_animation = !draw_array(ctx, 1, NUMBER_HEIGHT, NUMBER_WIDTH, NUMBER_HEIGHT,
                                 SHAPES2X2[middle_shape], true, 2, 2, color_spocks_m10) && stop_animation;
    stop_animation = !draw_array(ctx, NUMBER_WIDTH + 1, NUMBER_HEIGHT, NUMBER_WIDTH, NUMBER_HEIGHT,
                                 SHAPES2X2[middle_shape], true, 2, 2, color_spocks_m1) && stop_animation;
    ///// FIRST COLUMN:
    stop_animation = !draw_array(ctx, 0, 0, 1, -1, SHAPES2X2[middle_shape], true,
                                 2, 2, color_spocks_bt) && stop_animation;
    ///// LAST COLUMN:
    stop_animation = !draw_array(ctx, SPOCKS_SCREEN_WIDTH - 1, 0, 1, -1,
                                 SHAPES2X2[middle_shape], true, 2, 2, color_spocks_sec) && stop_animation;
  } else {
    ...
    if (show_zero_for_hours || hour10 != 0) {
      ...
      stop_animation = !draw_array(ctx, 1, 0, NUMBER_WIDTH, NUMBER_HEIGHT, SHAPES2X2[middle_shape], true, 
                                  NUMBER_WIDTH, NUMBER_HEIGHT, color_spocks_h10) && stop_animation;
    }
    ...
    if(is_sec_shown || (is_shake_active && sec_show_on_shake)) {
      ...
      stop_animation = !draw_array(ctx, SPOCKS_SCREEN_WIDTH - 1, 0, 1, -1, SHAPES2X2[middle_shape],
                                   true, 2, 2, color_spocks_sec) && stop_animation;
    }
    ...
    if(is_bt_shown || (is_shake_active && bt_show_on_shake)) {
      ...
      stop_animation = !draw_array(ctx, 0, 0, 1, 2, SHAPES2X2[middle_shape], true, 2, 2, color_spocks_bt) && stop_animation;
    }
    ...
    if(is_batt_shown || (is_shake_active && batt_show_on_shake)) {
      ...
      stop_animation = !draw_array(ctx, 0, 2, 1, -1, SHAPES2X2[middle_shape], true, 2, 2, color_spocks_bt) && stop_animation;
    }
